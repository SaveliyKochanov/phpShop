	...
	<main class="main">
		<div class="container">
			<div class="main__content">
				<h1 class="main__header">НОВАЯ КОЛЛЕКЦИЯ</h1>
				<div class="ticker">
					<div class="ticker__wrapper">
						<div class="ticker__item">Самовывоз из магазинов бесплатно</div>
						<div class="ticker__item">Самовывоз из магазинов бесплатно</div>
						<div class="ticker__item">Самовывоз из магазинов бесплатно</div>
						<div class="ticker__item">Самовывоз из магазинов бесплатно</div>
					</div>
					...
					<ul class="popular__list" id="slider">
						<li class="popular__list-item">
							<a class="popular__list-link" href="">
								<img class="popular__list-image" src="./images/popular-icons/card-1.png" alt="" />
								<span class="list-item__description">Куртки и ветровки</span>
							</a>
						</li>
						<li class="popular__list-item">
							<a class="popular__list-link" href="">
								<img class="popular__list-image" src="./images/popular-icons/card-2.png" alt="" />
								<span class="list-item__description">Джинсы</span>
							</a>
						</li>
						<li class="popular__list-item">
							<a class="popular__list-link" href="">
								<img class="popular__list-image" src="./images/popular-icons/card-3.png" alt="" />
								<span class="list-item__description">Рубашки</span>
							</a>
						</li>
						<li class="popular__list-item">
							<a class="popular__list-link" href="">
								<img class="popular__list-image" src="./images/popular-icons/card-4.png" alt="" />
